...
const ALLOWED = new Set(['product_view', 'search', 'compare_started', 'whatsapp_click', 'call_click', 'quote_started', 'generate_lead', 'finder_started', 'finder_completed', 'machine_recommendation', 'price_request']);
